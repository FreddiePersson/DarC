...
%%% BEGIN ENTRIES %%%
     'T:\Matlab tools;', ...
     'T:\Matlab tools\PicoHarp TTTR3;', ...
     'T:\Matlab tools\PicoHarp TTTR3\lib;', ...
     'T:\Matlab tools\Single molecule tracking simulations;', ...
     'T:\Matlab tools\True color images;', ...
     'T:\Matlab tools\background removal;', ...
     'T:\Matlab tools\background removal\backcorr;', ...
     'T:\Matlab tools\caseconvert;', ...
     'T:\Matlab tools\crossCorrelation;', ...
     'T:\Matlab tools\eng formating;', ...
     'T:\Matlab tools\estimate position;', ...
     'T:\Matlab tools\estimate position\real psfs;', ...
     'T:\Matlab tools\estimate position\real psfs\old versions;', ...
     'T:\Matlab tools\estimate position\simulation;', ...
     'T:\Matlab tools\evalTrackSingle;', ...
     'T:\Matlab tools\findFWHM;', ...
     'T:\Matlab tools\mathematical functions;', ...
     'T:\Matlab tools\mathematical functions\circ function;', ...
     'T:\Matlab tools\mathematical functions\ellipse;', ...
     'T:\Matlab tools\mathematical functions\gaussians;', ...
     'T:\Matlab tools\mathematical functions\hermite gauss;', ...
     'T:\Matlab tools\mathematical functions\mexican hat;', ...
     'T:\Matlab tools\mathematical functions\poisson;', ...
     'T:\Matlab tools\mathematical functions\polynomials;', ...
     'T:\Matlab tools\mathematical functions\rectangle;', ...
     'T:\Matlab tools\panzoom;', ...
     'T:\Matlab tools\plot_tools;', ...
     'T:\Matlab tools\polyfitweighted2;', ...
     'T:\Matlab tools\polyfitweighted2\polyfitweighted2;', ...
     'T:\Matlab tools\read phd files;', ...
     'T:\Matlab tools\referance maps;', ...
